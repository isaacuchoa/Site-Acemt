<?php 
	...
	$listagem = new BuscaAlteracaoArtigos();
...
<table width="64%" border="0" align="center">
  <tr>
    <td height="30" colspan="2"><div align="center" class="tituloform">Altera&ccedil;&atilde;o dos Artigos na P&aacute;gina principal</div></td>
  </tr>
  <tr>
      ...
      <table width="143%" border="0">
        ...
        <tr>
          <td colspan="3"><div align="center">
            ...
            <input name="idArtigos" type="hidden" id="idArtigos" value="<?php echo $_GET["id"]; ?>" />
            <input name="local" type="hidden" id="local" value="formAltArtigos" />
          </div></td>
          </tr>
      </table>
        </form>
