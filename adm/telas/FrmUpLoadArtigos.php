    ...
    <td valign="top"> 
      <form action="../funcoes/upload.php" method="post" enctype="multipart/form-data" name="formupload" id="formupload">
        <table width="100%" border="0" cellpadding="0" cellspacing="3" class="corpotabelascentrais">
          <tr> 
            <td width="100%" height="20" colspan="2" align="center" class="tituloform">Up-load das imagens presentes nos artigos da index</td>
          </tr>
          <tr align="center">
            <td height="10" colspan="2">&nbsp;</td>
          </tr>
          <tr>
            <td align="right" class="conteudoform">Imagem com tamanho (80X80) </td>
          ...
          <tr align="center"> 
            ...
            <input name="local" type="hidden" id="local" value="FrmUpArtigos">
            </td>
          </tr>
        </table>
      </form></td>
