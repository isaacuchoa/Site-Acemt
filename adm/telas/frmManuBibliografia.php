<?php 
	...
	$listagem->setUrl("?telas=frmManuBibliografia");
...
<table width="60%" border="0" align="center">
  <tr>
    <td height="30" colspan="2" bgcolor="#FFFFFF"><div align="center">Altera&ccedil;&atilde;o da Bibliografia ACEMT</div></td>
  </tr>
  <tr>
      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="46%"><input name="txtBusca" type="text" id="txtBusca" size="50" maxlength="120" />
            <input name="telas" type="hidden" id="telas" value="frmManuBibliografia" /></td>
      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td colspan="4"><table width="100%" border="0">
            ...
            <?php $listagem->geraManuBibliografia()?>
