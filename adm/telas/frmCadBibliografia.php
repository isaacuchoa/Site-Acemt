...
<table width="500" border="0" align="left">
  <tr>
    <td height="30" colspan="2"><div align="center" class="tituloform">Cadastro da Bibliografia ACEMT</div></td>
  </tr>
  <tr>
    <td colspan="2"><form action="funcoes/cadastros.php" method="post" name="frm" id="frm" onsubmit="return validaForm();">
      <table width="100%" border="0">
        ...
        <tr>
          <td width="30%" class="conteudoform">T&iacute;tulo da Bibliografia</td>
          <td colspan="2"><label>
        ...
        <tr>
          <td colspan="3"><table width="100%" border="0">
            <tr>
              <td class="conteudoform">Descri&ccedil;&atilde;o da Bibliografia</td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3"><div align="center">
            ...
            <input name="txtLocal" type="hidden" id="txtLocal" value="formBibliografia" />
          </div></td>
          </tr>
      </table>
        </form>
