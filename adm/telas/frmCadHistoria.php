...
<table width="500" border="0" align="left">
  <tr>
    <td height="30" colspan="2"><div align="center" class="tituloform">Cadastro da Hist&oacute;ria da ACEMT</div></td>
  </tr>
  <tr>
    <td colspan="2"><form action="funcoes/cadastros.php" method="post" name="frm" id="frm" onsubmit="return validaForm();">
      <table width="100%" border="0">
        ...
        <tr>
          <td width="24%" class="conteudoform">T&iacute;tulo da Hist&oacute;ria</td>
          <td colspan="2"><label>
        ...
        <tr>
          <td colspan="3"><table width="100%" border="0">
            <tr>
              <td class="conteudoform">Descri&ccedil;&atilde;o da hist&oacute;ria</td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3"><div align="center">
            ...
            <input name="txtLocal" type="hidden" id="txtLocal" value="formHistoria" />
          </div></td>
          </tr>
      </table>
        </form>
