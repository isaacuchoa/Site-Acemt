<?php 
	...
	$listagem->setUrl("?telas=frmManuSlideNoticias");
...
<table width="60%" border="0" align="center">
  <tr>
    <td height="30" colspan="2" bgcolor="#FFFFFF"><div align="center">Manuten&ccedil;&atilde;o das Not&iacute;cias no slide Index</div></td>
  </tr>
  <tr>
      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td colspan="4"><table width="100%" border="0">
            ...
            <?php $listagem->geraManuSlideNoticias()?>
